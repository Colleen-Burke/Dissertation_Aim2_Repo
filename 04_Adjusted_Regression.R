...
social_health_d_model_adj <- glm(
  chronic_pain ~ social_health_d + age + sex + race_f + ethnicity_f + bmi_measured + general_health + mental_health,
  data = analytic_data,
  family = binomial)
...
social_health2_d_model_adj <- glm(
  chronic_pain ~ social_health2_d + age + sex + race_f + ethnicity_f + bmi_measured + general_health + mental_health,
  data = analytic_data,
  family = binomial)
...
social_health_num_model_adj <- glm(
  chronic_pain ~ social_health_num + age + sex + race_f + ethnicity_f + bmi_measured + general_health + mental_health,
  data = analytic_data,
  family = binomial)
...
social_relationships_num_model_adj <- glm(
  chronic_pain ~ social_relationships_num + age + sex + race_f + ethnicity_f + bmi_measured + general_health + mental_health,
  data = analytic_data,
  family = binomial)
...
isolation_score_model_adj <- glm(
  chronic_pain ~ isolation_score + age + sex + race_f + ethnicity_f + bmi_measured + general_health + mental_health,
  data = analytic_data,
  family = binomial)
...
social_activities_d_model_adj <- glm(
  chronic_pain ~ social_activities_d + age + sex + race_f + ethnicity_f + bmi_measured + general_health + mental_health,
  data = analytic_data,
  family = binomial)
...
social_relationships_d_model_adj <- glm(
  chronic_pain ~ social_relationships_d + age + sex + race_f + ethnicity_f + bmi_measured + general_health + mental_health,
  data = analytic_data,
  family = binomial)
...
isolation_cat_d_model_adj <- glm(
  chronic_pain ~ isolation_cat_d + age + sex + race_f + ethnicity_f + bmi_measured + general_health + mental_health,
  data = analytic_data,
  family = binomial)
...
social_activities2_d_model_adj <- glm(
  chronic_pain ~ social_activities2_d + age + sex + race_f + ethnicity_f + bmi_measured + general_health + mental_health,
  data = analytic_data,
  family = binomial)
...
social_relationships2_d_model_adj <- glm(
  chronic_pain ~ social_relationships2_d + age + sex + race_f + ethnicity_f + bmi_measured + general_health + mental_health,
  data = analytic_data,
  family = binomial)
...
isolation_cat2_d_model_adj <- glm(
  chronic_pain ~ isolation_cat2_d + age + sex + race_f + ethnicity_f + bmi_measured + general_health + mental_health,
  data = analytic_data,
  family = binomial)
